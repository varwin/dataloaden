### The DATALOADer gENerator [![CircleCI](https://circleci.com/gh/varwin/dataloaden.svg?style=svg)](https://circleci.com/gh/varwin/dataloaden) [![Go Report Card](https://goreportcard.com/badge/github.com/varwin/dataloaden)](https://goreportcard.com/report/github.com/varwin/dataloaden) [![codecov](https://codecov.io/gh/varwin/dataloaden/branch/master/graph/badge.svg)](https://codecov.io/gh/varwin/dataloaden)
...
```bash
go run github.com/varwin/dataloaden UserLoader string *github.com/dataloaden/example.User
```
...
```bash
go run github.com/varwin/dataloaden UserSliceLoader string []*github.com/dataloaden/example.User
```
...
import _ "github.com/varwin/dataloaden"
```

This will allow go modules to see the dependency.

You can invoke it from anywhere within your module now using `go run github.com/varwin/dataloaden` and 
